...
#  echo trial number $counter
  ...
  python -m scripts.move_kuka_branches_angle_based_v4 --env "$2" --deflection_limit "$4" --video_filename "$3"/video_recordings/"$2"/trial"$counter".mp4 > "$3"/program_text_output/"$2"/trial"$counter".txt
