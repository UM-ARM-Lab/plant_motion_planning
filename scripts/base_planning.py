...
husky_utils = HuskyUtils(env, floor, z_coord, device, arm_joints, HDT_MICHIGAN_SRDF)
...
path,old_path = rrt_solve((start, q), (goal, q), dynamics_fn, steering_fn, connect_fn, collision_fn, env.save_state, env.restore_state,
