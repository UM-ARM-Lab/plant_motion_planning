...
from pybullet_tools.kuka_primitives import BodyPose, BodyConf, Command, get_grasp_gen, \
    ...
    get_free_motion_gen_with_angle_constraints_v4, get_free_motion_gen_with_angle_constraints_v5
...
def move_arm_conf2conf(robot, fixed, movable, deflection_limit, conf_i, conf_g, teleport=False):
    ...
    free_motion_fn = get_free_motion_gen_with_angle_constraints_v5(robot, start_state_id, fixed= fixed, movable = movable,
